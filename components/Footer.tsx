...
const columns: { title: string; links: FootLink[] }[] = [
  {
    ...
    links: [
      ...
      { label: "Machines automatiques", href: "/machines/a-grains" },
      { label: "Machines expresso", href: "/machines/a-grains" },
      { label: "Machines à capsules", href: "/machines/a-grains" },
      { label: "Machines compactes", href: "/machines/a-grains" },
    ],
  },
  {
    title: "Comparatifs",
    links: [
      { label: "Meilleures machines", href: "/comparateur" },
      { label: "Par budget", href: "/comparateur" },
      { label: "Par besoin", href: "/comparateur" },
      { label: "Face-à-face", href: "/comparatifs/delonghi-vs-philips" },
      { label: "Tous les tests", href: "/tests/magnifica-evo" },
    ],
  },
  {
    title: "Guides",
    links: [
      { label: "Comment choisir", href: "/guides/grains-ou-capsules" },
      { label: "Grains ou capsules", href: "/guides/grains-ou-capsules" },
      { label: "Entretien et détartrage", href: "/guides/grains-ou-capsules" },
      { label: "Le coût réel d'un café", href: "/guides/grains-ou-capsules" },
